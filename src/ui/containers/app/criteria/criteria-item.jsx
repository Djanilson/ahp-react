    ...
    >
      <div style={{
        ...
        <div style={{textAlign: 'center', width: '50%'}}>
          <strong style={{textAlign: 'center', width: '100%', display: "inline-block", fontSize: 18}}>
            ({getFirstOptionsValue()})
          </strong>
          <span>{props.comparison.firstOption.name}</span>
        </div>
        X
        <div style={{textAlign: 'center', width: '50%'}}>
          <strong style={{textAlign: 'center', width: '100%', display: "inline-block", fontSize: 18}}>
            ({getSecondOptionsValue()})
          </strong>
          <span>{props.comparison.secondOption.name}</span>
        </div>
      </div>
