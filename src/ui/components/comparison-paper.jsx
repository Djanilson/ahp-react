...
const ComparisonPaper = (props) => {
  ...
  return(
    <Paper style={{
      ...
      <p style={{width: "100%", padding: "1em 2em"}}>{props.title}</p>
      <div style={{
          display: 'flex',
          padding: 20,
        ...
        <div style={{textAlign: 'center', width: '50%', fontSize: 30}}>
          <strong>
            {props.comparison.firstOption.name}
            <span style={{fontSize: 15}}> ({getFirstOptionsValue()})</span>
          </strong>
        </div>
        X
        <div style={{textAlign: 'center', width: '50%', fontSize: 30,}}>
          <strong>
            {props.comparison.secondOption.name}
            <span style={{fontSize: 15}}> ({getSecondOptionsValue()})</span>
          </strong>
        </div>
      </div>
      <div style={{paddingLeft: 10, paddingRight: 10}}>
        <Slider
          ...
          sliderStyle={{marginBottom: 20, selectionColor: "red"}}
